...
6. 채용한 직원 중 프로젝트 참가자 3명 편성
7. 요구사항 변경·긴급회의·예산 삭감·고객 승인 돌발 상황
...
화면은 Android 세로 모드를 기준으로 설계했습니다. 기준 해상도는 `360×780`이며 Canvas Scaler, 앵커 레이아웃과 안전 영역 보정으로 `9:16`부터 `9:21`까지 대응합니다. 전투에서는 프로젝트 보스가 위쪽, 직원이 아래쪽에 배치되고 업무 효과가 아래에서 위로 이동합니다.

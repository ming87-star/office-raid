...
5. 절차적으로 생성된 후보자 면접과 채용
6. PM·영업·개발의 업무 연계 자동 전투
7. 프로젝트 완료 후 현금·평판·장비 획득
8. 채용한 직원 중 프로젝트 참가자 3명 편성
9. 요구사항 변경·긴급회의·예산 삭감·고객 승인 돌발 상황
10. 게이지 충전 시 자동 일시 정지, 직원별 스킬 선택과 `PERFECT WORKFLOW` 연계 연출
11. 프로젝트 성공으로 갱신되는 상시채용 공고와 헤드헌팅권 기반 특별채용
12. 회사 운영 상태 자동 저장, 첫 화면 이어하기와 확인 절차가 있는 새 게임 초기화

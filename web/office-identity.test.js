...
assert.match(game, /class="desk-identity"><strong>\$\{escapeHtml\(member\.name\)\}<\/strong><small>\$\{executive \? "대표 전용석" : `\$\{DEPARTMENTS\[member\.department\]\.short\} · \$\{employeePosition\(member\)\}`\}<\/small>/);
